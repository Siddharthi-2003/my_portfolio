...
const Reader = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="fixed top-0 w-full z-50 bg-gradient-to-b from-black to-transparent px-8 py-4">
        <div className="flex items-center justify-between">
          <h1 className="text-red-600 text-4xl font-bold">READER</h1>
      ...
      <div className="relative h-screen">
        ...
        <div 
          className="absolute inset-y-0 right-0 w-1/2 bg-cover bg-center opacity-100"
        ...
        <div className="relative z-10 h-full flex items-center px-12 max-w-3xl">
          <div>
            ...
            <div className="flex gap-4">
              <button className="bg-white text-black px-8 py-3 rounded text-xl font-bold hover:bg-gray-200 flex items-center gap-2">
                ▶ Start Reading
              </button>
              <button className="bg-gray-600/80 px-8 py-3 rounded text-xl font-bold hover:bg-gray-600 flex items-center gap-2">
                ⓘ More Info
              </button>
            </div>
          </div>
      ...
      <div className="relative z-20 -mt-32 px-12 pb-12">
        ...
        {/* Row 1 */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-4 text-white">📚 Trending Now: Hot Takes & Cool Code</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className={`bg-gradient-to-br ${item.color} rounded-lg p-6 hover:scale-105 transition-transform cursor-pointer shadow-xl`}>
        ...
        {/* Row 2 */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-4 text-white">🎬 Documentaries (aka Long Reads)</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className={`bg-gradient-to-br ${item.color} rounded-lg p-6 hover:scale-105 transition-transform cursor-pointer shadow-xl border border-gray-700`}>
                <div className="text-5xl mb-3">{item.emoji}</div>
                <h3 className="text-lg font-bold mb-2">{item.title}</h3>
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-4 text-white">💡 Because You Watched: "How Not to Code"</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
        ...
        {/* Info Section */}
        <div className="bg-gradient-to-r from-red-900/40 to-black rounded-lg p-8 border border-red-800/50 shadow-2xl mb-8">
          <h2 className="text-3xl font-bold mb-4 text-red-500">🍿 About This Profile</h2>
